...
function show_tieUp(element_name, element_color, msg) {
  ...
  stop_next_button();
  let play_again_btn = document.querySelector('#para-btn')
...
function show_result_for_user(user_btn_color, user_element_name, pc_btn_color, pc_element_name, msg, msg2) {
  stop_game_show_result();
...
function show_result_for_pc(pc_btn_color, pc_element_name, user_btn_color, user_element_name, msg, msg2) {
  stop_game_show_result();
  stop_all_user_circle();
  show_all_pc_circle();
  stop_next_button();
...
function rock() {
  ...
  if (computerChoice === "rock") {
    ...
    let point = show_result_for_pc("#ffa943", "paper", "#0074b6", "rock", "YOU LOST", "AGAINST PC");
    let pc_score = document.querySelector(".pc-score");
    let final_value = parseInt(pc_score.value) + point;
    set_pc_score(final_value);
  } else {
    let point = show_result_for_user( "#0074B6", "rock", "#bd00ff", "scissor", "YOU WIN", "AGAINST PC");
    let user_score = document.querySelector(".user-score");
...
function paper() {
  ...
  if (computerChoice === "paper") {
    ...
    let point = show_result_for_user( "#ffa943", "paper", "#0074b6", "rock", "YOU WIN", "AGAINST PC");
    let user_score = document.querySelector(".user-score");
    let final_value = parseInt(user_score.value) + point;
    set_user_score(final_value);
  } else {
    let point = show_result_for_pc( "#bd00ff", "scissor", "#ffa943", "paper", "YOU LOST", "AGAINST PC");
    let pc_score = document.querySelector(".pc-score");
    let final_value = parseInt(pc_score.value) + point;
    set_pc_score(final_value);
  }
...
function scissor() {
  ...
  if (computerChoice === "scissor") {
    ...
    let point = show_result_for_pc("#0074b6","rock","#bd00ff","scissor","YOU LOST","AGAINST PC");
    let pc_score = document.querySelector(".pc-score");
    let final_value = parseInt(pc_score.value) + point;
    set_pc_score(final_value);
  } else {
    let point = show_result_for_user( "#bd00ff", "scissor", "#ffa943", "paper", "YOU WIN", "AGAINST PC");
    let user_score = document.querySelector(".user-score");
    let final_value = parseInt(user_score.value) + point;
    set_user_score(final_value);
  }
